...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Line Charts/Liam Hendriks Comp.csv")
...
cols <- c("Bobby Parnell" = "#FF5910", "Kevin Gregg" = "#00A3E0", "Mike DeJean" = "#FFC52F",
          "Cliff Politte" = "#C4CED4", "David Hernandez" = "#A71930", "Liam Hendriks" = "#27251F")
...
p <- data %>%
  ...
  ease_aes("linear") +
  #view_follow() +
  labs(title = "Liam Hendriks vs.Top 5 Bill James Similarity Scores", subtitle = "Only Includes Players Who Have Finished Their Career", x = "Season Age", y = "Career WAR")

#Animate the visual

anim <- animate(p, nframes = 21, fps = 1, width = 800, height = 482, end_pause = 5, renderer = magick_renderer())

anim_save("Liam Hendriks Comp.gif", anim)