...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Line Charts/Carlos Correa Comp.csv")
...
cols <- c("Troy Tulowitzki" = "#33006F", "Gary Carter" = "#003087", "Vern Stephens" = "chocolate4",
          "Joe Torre" = "#CE1141", "Travis Fryman" = "#0C2340", "Carlos Correa" = "#EB6E1F")
...
p <- data %>%
  ...
  ease_aes("linear") +
  #view_follow() +
  labs(title = "Carlos Correa WAR vs. Top 5 Bill James Similarity Scores", subtitle = "Only Includes Players Who Have Finished Their Career", x = "Season Age", y = "Career WAR")

#Animate the visual

anim <- animate(p, nframes = 25, fps = 1, width = 800, height = 482, end_pause = 5, renderer = magick_renderer())

anim_save("Carlos Correa Comp.gif", anim)