...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most Times Reaching X Streak/Orioles")
...
TeamsFranchises.franchID, SUM(Batting.HR) AS HR,
...
top_data <- data %>%
  arrange(-Times, desc(nameFirst), -MIN) %>%
...
top_data %>%
  ...
  scale_fill_manual(values = c("Even" = "#DF4601", "Odd" = "#000000")) +
  ...
  labs(title = "Most Consecutive Seasons with 25 or More Home Runs as an Oriole",
       x = "",
       y = "Consecutive 25+ Home Run Seasons")