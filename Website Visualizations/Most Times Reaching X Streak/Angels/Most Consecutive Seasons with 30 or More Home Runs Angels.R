...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most Times Reaching X Streak/Angels")
...
top_data %>%
  ...
  scale_fill_manual(values = c("Even" = "#003263", "Odd" = "#BA0021")) +
  ...
  labs(title = "Most Consecutive Seasons with 30 or More Home Runs as an Angel",
       x = "",
