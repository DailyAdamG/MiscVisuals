...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Los Angeles Dodgers")
...
top_data %>%
  ...
  labs(title = "Los Angeles Dodgers Franchise History\nMost Home Runs in a 5 Season Span",
