...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Atlanta Braves")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Atlanta Braves/Most Position Player WAR in 3 Season Span Braves.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Hank Aaron' | MIN != 1965 & MIN != 1956)
...
top_data %>%
  ...
  coord_flip(ylim = c(15, 26)) +
  scale_y_continuous(breaks = seq(15, 26, 1)) +
  ...
  labs(title = "Atlanta Braves Franchise History\nMost Position Player WAR in a 3 Season Span",
