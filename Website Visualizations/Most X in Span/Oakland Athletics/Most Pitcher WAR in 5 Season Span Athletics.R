...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Oakland Athletics")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Oakland Athletics/Most Pitcher WAR in 5 Season Span Athletics.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Eddie Plank' | MIN != 1906)
...
top_data %>%
  ...
  coord_flip(ylim = c(15, 37)) +
  scale_y_continuous(breaks = seq(15, 37, 1)) +
  scale_fill_manual(values = c("Odd" = "#003831", "Even" = "#EFB21E")) +
  ...
  labs(title = "Oakland Athletics Franchise History\nMost Pitching WAR in a 5 Season Span",
