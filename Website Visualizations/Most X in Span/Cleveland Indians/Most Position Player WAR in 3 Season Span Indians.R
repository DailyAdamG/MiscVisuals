...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Cleveland Indians/Most Position Player WAR in 3 Season Span Indians.csv")
...
top_data %>%
  ...
  coord_flip(ylim = c(16, 26)) +
  scale_y_continuous(breaks = seq(16, 26, 1)) +
