...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/New York Yankees/Most Pitching WAR in 3 Season Span Yankees.csv")
