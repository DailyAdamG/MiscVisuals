...
top_data %>%
  ...
  coord_flip(ylim = c(1.150, 1.400)) +
  scale_y_continuous(breaks = seq(1.150, 1.400, .020), labels = numformat) +
  ...
  labs(title = "Highest OPS in a 3 Season Span\n(Minimum of 1500 Plate Appearances)",
