...
TeamsFranchises.franchName AS Teams, TeamsFranchises.franchID, SUM(Batting.HR) AS HR
                    ...
                    WHERE TeamsFranchises.franchName = "Philadelphia Phillies"
...
top_data %>%
  ...
  coord_flip(ylim = c(120, 230)) +
  scale_y_continuous(breaks = seq(120, 230, 5)) +
  ...
  labs(title = "Philadelphia Phillies Franchise History\nMost Home Runs in a 5 Season Span",
