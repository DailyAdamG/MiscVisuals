...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Philadelphia Phillies")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Philadelphia Phillies/Most Pitching WAR in 3 Season Span Phillies.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Pete Alexander' | MIN != 1912)
...
top_data %>%
  ...
  coord_flip(ylim = c(15, 27)) +
  scale_y_continuous(breaks = seq(15, 27, 1)) +
  scale_fill_manual(values = c("Odd" = "#E81828", "Even" = "#002D72")) +
  ...
  labs(title = "Philadelphia Phillies History\nMost Pitching WAR in a 3 Season Span",
