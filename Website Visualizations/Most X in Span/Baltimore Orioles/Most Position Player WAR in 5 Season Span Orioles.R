...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Baltimore Orioles/Most Position Player WAR in 3 Season Span Orioles.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Cal Ripken' | MIN != 1987)
