...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Cincinnati Reds/Most WAR in 5 Season Span Reds.csv")
...
top_data %>%
  ...
  coord_flip(ylim = c(25, 48)) +
  scale_y_continuous(breaks = seq(25, 48, 1)) +
  ...
  labs(title = "Cincinnati Reds History\nMost WAR in a 5 Season Span",
