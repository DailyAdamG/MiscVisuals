...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Tampa Bay Rays/Most WAR in 5 Season Span Rays.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Evan Longoria' | MIN != 2014)
