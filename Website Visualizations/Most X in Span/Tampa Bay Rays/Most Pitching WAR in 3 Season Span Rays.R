...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Tampa Bay Rays")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Tampa Bay Rays/Most Pitching WAR in 3 Season Span Rays.csv")
...
top_data %>%
  ...
  scale_fill_manual(values = c("Odd" = "#092C5C", "Even" = "#8FBCE6")) +
