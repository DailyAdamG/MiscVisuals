...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/San Diego Padres")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/San Diego Padres/Most Pitching WAR in 5 Season Span Padres.csv")
...
top_data %>%
  ...
  geom_text(aes(label = WAR_Total), fontface = "bold", hjust = -0.3) +
  coord_flip(ylim = c(0, 25)) +
  scale_y_continuous(breaks = seq(0, 25, 5)) +
  scale_fill_manual(values = c("Odd" = "#2F241D", "Even" = "#FFC425")) +
  ...
  labs(title = "San Diego Padres Franchise History\nMost Pitching WAR in a 5 Season Span",
