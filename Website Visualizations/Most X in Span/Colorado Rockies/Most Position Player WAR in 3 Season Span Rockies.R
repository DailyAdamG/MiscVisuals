...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Colorado Rockies")
...
data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/Website Visualizations/Most X in Span/Colorado Rockies/Most Position Player WAR in 3 Season Span Rockies.csv")
...
no_dupes <- no_dupes %>%
  filter(Name != 'Todd Helton' | MIN != 2004)
...
top_data %>%
  ...
  coord_flip(ylim = c(10, 21)) +
  scale_y_continuous(breaks = seq(10, 21, 1)) +
  scale_fill_manual(values = c("Odd" = "#33006F", "Even" = "#C4CED4")) +
  ...
  labs(title = "Colorado Rockies Franchise History\nMost Position Player WAR in a 3 Season Span",
