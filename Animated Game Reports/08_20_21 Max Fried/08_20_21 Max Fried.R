...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_20_21 Max Fried")
...
data <- read.csv("08_20_21 Max Fried.csv")
...
anim_save("08_20_21 Max Fried.gif", c(anim1, anim2, anim3, anim4, anim5,
