...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_22_21 Ian Anderson")
...
data <- read.csv("09_22_21 Ian Anderson.csv")
...
anim_save("09_22_21 Ian Anderson.gif", c(anim1, anim2, anim3, anim4, anim5,
