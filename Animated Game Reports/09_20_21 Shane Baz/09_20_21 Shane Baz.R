...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_20_21 Shane Baz")
...
data <- read.csv("09_20_21 Shane Baz.csv")
...
anim_save("09_20_21 Shane Baz.gif", c(anim1, anim2, anim3, anim4, anim5,
