...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_14_21 Tyler Gilbert")
...
data <- read.csv("08_14_21 Tyler Gilbert.csv")
...
anim_save("08_14_21 Tyler Gilbert.gif", c(anim1, anim2, anim3, anim4, anim5,
