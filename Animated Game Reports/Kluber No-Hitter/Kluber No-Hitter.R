...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/Kluber No-Hitter")
...
data <- read.csv("Kluber No-Hitter.csv")
...
anim_save("Kluber No-Hitter.gif", c(anim1, anim2, anim3, anim4, anim5,
