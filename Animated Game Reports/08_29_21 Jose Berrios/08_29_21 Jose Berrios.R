...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_29_21 Jose Berrios")
...
data <- read.csv("08_29_21 Jose Berrios.csv")
...
anim_save("08_29_21 Jose Berrios.gif", c(anim1, anim2, anim3, anim4, anim5,
