...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_11_21 Corbin Burnes")
...
data <- read.csv("08_11_21 Corbin Burnes.csv")
...
anim_save("08_11_21 Corbin Burnes.gif", c(anim1, anim2, anim3, anim4, anim5,
