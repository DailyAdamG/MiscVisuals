...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_28_21 Sandy Alcantara")
...
data <- read.csv("08_28_21 Sandy Alcantara.csv")
...
anim_save("08_28_21 Sandy Alcantara.gif", c(anim1, anim2, anim3, anim4, anim5,
