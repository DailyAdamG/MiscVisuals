...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_01_21 Gerrit Cole")
...
data <- read.csv("09_01_21 Gerrit Cole.csv")
...
anim_save("09_01_21 Gerrit Cole.gif", c(anim1, anim2, anim3, anim4, anim5,
