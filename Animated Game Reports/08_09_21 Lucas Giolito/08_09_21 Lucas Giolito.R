...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_09_21 Lucas Giolito")
...
data <- read.csv("08_09_21 Lucas Giolito.csv")
...
anim_save("08_09_21 Lucas Giolito.gif", c(anim1, anim2, anim3, anim4, anim5,
