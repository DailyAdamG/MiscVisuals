...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_30_21 Robbie Ray")
...
data <- read.csv("08_30_21 Robbie Ray.csv")
...
anim_save("08_30_21 Robbie Ray.gif", c(anim1, anim2, anim3, anim4, anim5,
