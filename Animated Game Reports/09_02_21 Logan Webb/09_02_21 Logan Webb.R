...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_02_21 Logan Webb")
...
data <- read.csv("09_02_21 Logan Webb.csv")
...
anim_save("09_02_21 Logan Webb.gif", c(anim1, anim2, anim3, anim4, anim5,
