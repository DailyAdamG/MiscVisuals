...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_27_21 Joe Musgrove")
...
data <- read.csv("08_27_21 Joe Musgrove.csv")
...
anim_save("08_27_21 Joe Musgrove.gif", c(anim1, anim2, anim3, anim4, anim5,
