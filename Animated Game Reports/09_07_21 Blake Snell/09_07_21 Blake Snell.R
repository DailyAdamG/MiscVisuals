...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_07_21 Blake Snell")
...
data <- read.csv("09_07_21 Blake Snell.csv")
...
anim_save("09_07_21 Blake Snell.gif", c(anim1, anim2, anim3, anim4, anim5,
