...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_17_21 Luis Castillo")
...
data <- read.csv("09_17_21 Luis Castillo.csv")
...
anim_save("09_17_21 Luis Castillo.gif", c(anim1, anim2, anim3, anim4, anim5,
