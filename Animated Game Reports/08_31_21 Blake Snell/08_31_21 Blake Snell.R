...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_31_21 Blake Snell")
...
data <- read.csv("08_31_21 Blake Snell.csv")
...
anim_save("08_31_21 Blake Snell.gif", c(anim1, anim2, anim3, anim4, anim5,
