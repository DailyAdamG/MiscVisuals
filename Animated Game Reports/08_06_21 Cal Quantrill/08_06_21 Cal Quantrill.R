...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_06_21 Cal Quantrill")
...
data <- read.csv("08_06_21 Cal Quantrill.csv")
...
anim_save("08_06_21 Cal Quantrill.gif", c(anim1, anim2, anim3, anim4, anim5,
