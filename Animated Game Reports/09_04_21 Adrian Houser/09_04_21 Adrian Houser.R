...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_04_21 Adrian Houser")
...
data <- read.csv("09_04_21 Adrian Houser.csv")
...
anim_save("09_04_21 Adrian Houser.gif", c(anim1, anim2, anim3, anim4, anim5,
