...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_10_21 Julio Urias")
...
data <- read.csv("09_10_21 Julio Urias.csv")
...
anim_save("09_10_21 Julio Urias.gif", c(anim1, anim2, anim3, anim4, anim5,
