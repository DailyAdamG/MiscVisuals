...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_24_21 Dylan Cease")
...
data <- read.csv("08_24_21 Dylan Cease.csv")
...
anim_save("08_24_21 Dylan Cease.gif", c(anim1, anim2, anim3, anim4, anim5,
