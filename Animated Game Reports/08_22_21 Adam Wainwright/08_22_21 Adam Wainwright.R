...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_22_21 Adam Wainwright")
...
data <- read.csv("08_22_21 Adam Wainwright.csv")
...
anim_save("08_22_21 Adam Wainwright.gif", c(anim1, anim2, anim3, anim4, anim5,
