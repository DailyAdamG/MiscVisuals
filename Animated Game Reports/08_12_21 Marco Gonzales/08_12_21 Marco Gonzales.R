...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/08_12_21 Marco Gonzales")
...
data <- read.csv("08_12_21 Marco Gonzales.csv")
...
anim_save("08_12_21 Marco Gonzales.gif", c(anim1, anim2, anim3, anim4, anim5,
