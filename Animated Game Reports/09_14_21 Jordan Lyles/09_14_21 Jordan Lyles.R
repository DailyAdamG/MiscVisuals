...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_14_21 Jordan Lyles")
...
data <- read.csv("09_14_21 Jordan Lyles.csv")
...
anim_save("09_14_21 Jordan Lyles.gif", c(anim1, anim2, anim3, anim4, anim5,
