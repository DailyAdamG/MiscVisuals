...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/Animated Game Reports/09_18_21 Yu Darvish")
...
data <- read.csv("09_18_21 Yu Darvish.csv")
...
anim_save("09_18_21 Yu Darvish.gif", c(anim1, anim2, anim3, anim4, anim5,
