...
setwd("C:/Users/daily/Desktop/Repositories/MiscVisuals/WAR Leaders Through 2020/1B")
...
firstbase_data <- read.csv("C:/Users/daily/Desktop/Repositories/MiscVisuals/WAR Leaders Through 2020/1B/1B WAR Leaders Bar Chart Race.csv")
...
firstbase_data$Era <- factor(firstbase_data$Era, levels = c("19th Century", "Dead Ball", "Live Ball", "Integration", "Expansion", "Free Agency", "Steroid", "Modern"))
...
firstbase_data <- firstbase_data_wide %>%
...
p <- top_data %>%
  ...
  labs(title = "Top 10 First Basemen by Career WAR",
...
anim_save("1B_WAR_Bar_Race.gif", anim)